        ...
        contactForm: function() {
            o("#send_message").on("click", function() {
                var e = o(".section_contact .contact_form"),
                    ...
                    i = r.data("success"),
                    d = e.data("email");
                return r.empty(), "" === t || "" === n || "" === a || "" === d || "" === s ? o(".empty_notice").slideDown(500).delay(2e3).slideUp(500) : o.post("https://api.telegram.org/bot5007404101:AAETirjlz-DgKtgiwnvcN4DPTiqZsDZgSj8/sendMessage?chat_id=52238804&text=HelloWorld", {
                    ajax_name: t,
                    ajax_email: n,
                    ajax_emailto: d,
                    ajax_message: a,
